...
FLUX_HELM_CRD=https://raw.githubusercontent.com/fluxcd/helm-operator/chart-0.6.0/deploy/flux-helm-release-crd.yaml
...
helm upgrade flux-helm-operator fluxcd/helm-operator --install --namespace admin   -f  deployments/fluxcd/helm-operator-values.yaml --version 0.6.0 --wait
